...
<style type="text/tailwindcss">
  ...
  @layer components {
    ...
    .semantic-tailwind textarea {
      @apply border-border focus:border-background border-border text-foreground bg-background hover:border-primary hover:ring-primary rounded-xl border font-normal hover:outline-none;
    }
    ...
    /**
         * Currently styling placeholder for date input is not supported
         * https://stackoverflow.com/questions/14507119/is-it-possible-to-style-the-default-placeholder-text-on-an-html5-input-type-dat
         */
    /* .semantic-tailwind input[type='date']::placeholder {
          @apply text-neutral-500;
        } */
    ...
    .semantic-tailwind button[type='submit'],
    ...
    .semantic-tailwind input[type='submit'] {
      /* HOTFIX: not sure why the height is 36px compared to other inputs which are 38px */
      @apply h-[38px] rounded-xl;
    }

    .semantic-tailwind button[type='submit'] {
      @apply focus:bg-primary/80 !important;
    }
